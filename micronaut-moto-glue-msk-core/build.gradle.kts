...
dependencies {
    ...
    implementation(project(":micronaut-moto-glue-msk-schema-registry"))
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("Micronaut Moto Glue MSK Core")
                description.set("Core library for Micronaut Moto Glue MSK")
